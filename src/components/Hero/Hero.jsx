    ...
    <header>
      <div className="hero-desc">
        <div className="hero-content">
          <div className="hero-greeting">Welcome to Tech Quiz</div>
          <div className="hero-text">
            Ready to boost your tech Knowledge with thrilling quizzes?
          </div>
        </div>
        <button className="action-btn" onClick={() => setRoute("/quiz")}>
          <svg
      ...
      <div className="hero-video">
        ...
        <a
          ...
          href="https://giphy.com/gifs/a-set-per-affair-f8TXO6yBb8CgU"
          target="_blank"
